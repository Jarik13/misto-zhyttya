...
public record RegistrationRequest(
        ...
        @NotBlank(message = "Ім'я користувача не повинно бути порожнім")
        ...
        @NotBlank(message = "Підтвердження пароля не повинно бути порожнім")
        String confirmPassword,

        @Schema(description = "Номер телефону у міжнародному форматі", example = "+380991234567")
        @NotBlank(message = "Номер телефону не повинен бути порожнім")
        ...
        @NotNull(message = "Дата народження не повинна бути порожньою")
        ...
        @NotNull(message = "Стать не може бути бути порожньою")
        @Min(value = 0, message = "Ідентифікатор статі має бути не менше за 0")
        @Max(value = 3, message = "Ідентифікатор статі має бути не більше за 3")
        Long genderId
) {
}

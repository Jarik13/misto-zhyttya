...
public record ChangePasswordRequest(
        ...
        @NotBlank(message = "Поточний пароль не повинен бути порожнім")
        ...
        @NotBlank(message = "Новий пароль не повинен бути порожнім")
        ...
        @NotBlank(message = "Підтвердження нового пароля не повинно бути порожнім")

...
public class CookieUtilsTests {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(cookieUtils, "accessTokenExpiration", 3600000L);  // 1 hour
        ReflectionTestUtils.setField(cookieUtils, "refreshTokenExpiration", 7200000L); // 2 hours
    }

    // region: Access Token - Add

    @Test
    void givenAccessToken_whenAddAccessTokenCookie_thenCookieIsAddedWithCorrectAttributes() {
    ...
    @Test
    void givenNullResponse_whenAddAccessTokenCookie_thenThrowsException() {
        HttpServletResponse response = null;
        String token = "testToken";

        assertThrows(NullPointerException.class, () -> cookieUtils.addAccessTokenCookie(response, token));
    }

    // endregion


    // region: Access Token - Clear

    @Test
    void givenNoValue_whenClearAccessTokenCookie_thenCookieIsCleared() {
        HttpServletResponse response = mock(HttpServletResponse.class);
    ...
    @Test
    void givenNullResponse_whenClearAccessTokenCookie_thenThrowsException() {
        HttpServletResponse response = null;

        assertThrows(NullPointerException.class, () -> cookieUtils.clearAccessTokenCookie(response));
    }

    // endregion


    // region: Access Token - Get

    @Test
    void givenAccessTokenCookieExists_whenGetAccessToken_thenReturnsTokenValue() {
    ...
    @Test
    void givenNoAccessTokenCookie_whenGetAccessToken_thenReturnsNull() {
    ...
    @Test
    void givenNullCookies_whenGetAccessToken_thenReturnsNull() {
        HttpServletRequest request = mock(HttpServletRequest.class);
    ...
    @Test
    void givenEmptyCookiesArray_whenGetAccessToken_thenReturnsNull() {
        HttpServletRequest request = mock(HttpServletRequest.class);
    ...
    @Test
    void givenNullRequest_whenGetAccessToken_thenThrowsException() {
        HttpServletRequest request = null;

        assertThrows(NullPointerException.class, () -> cookieUtils.getAccessToken(request));
    }
